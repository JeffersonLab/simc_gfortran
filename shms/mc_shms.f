...
c	parameter(zd_fp    = 327.00)
	...
	parameter(zd_hbmen = 20.06)
        parameter(zd_hbmex = 75.134)
        parameter(zd_hbout = 20.06)
c	parameter (z_entr = 52.04) ! 6.35 cm in front of Q1
	...
	parameter (z_thick =6.35) !6.35 cm thick
        ...
        parameter(zd_q1men = 28.05)
        parameter(zd_q1mid = 93.95)
        parameter(zd_q1mex = 93.95)
        parameter(zd_q1out = 28.05)
        parameter(zd_q2in  = 25.55)
        parameter(zd_q2men = 36.45)
        parameter(zd_q2mid = 82.00)
        parameter(zd_q2mex = 81.99)
        parameter(zd_q2out = 36.45)
        parameter(zd_q3in  = 28.10)
        parameter(zd_q3men = 36.45)
        parameter(zd_q3mid = 82.00)
        parameter(zd_q3mex = 81.99)
        parameter(zd_q3out = 36.45)
        parameter(zd_q3d1trans  = 18.00)
        parameter(zd_d1flare = 30.10)
c        parameter(zd_d1men = 39.50)
        parameter(zd_d1men = 39.47)
        parameter(zd_d1mid1= 36.88)
        parameter(zd_d1mid2= 36.88)
        parameter(zd_d1mid3= 36.88)
        parameter(zd_d1mid4= 36.88)
        parameter(zd_d1mid5= 36.88)
        parameter(zd_d1mid6= 36.88)
        parameter(zd_d1mid7= 36.88)
        parameter(zd_d1mex = 36.88)
        parameter(zd_d1out = 60.68)
c        parameter(zd_fp    = 308.00)
